...
var AttendenceList = []schoolForm.Attendance{
	{
		UserId:     5,
		Role:       "Rescue",
		MinProfile: MinProfileList[4],
	},
	{
		UserId:     6,
		Role:       "Watcher",
		MinProfile: MinProfileList[5],
	},
	{
		UserId:     7,
		Role:       "Watcher",
		MinProfile: MinProfileList[6],
	},
}

// For those with full profile
var FullAttendanceList = []schoolForm.FullAttendance{
	{
		UserId:      1,
		Role:        "Host",
		Jobs:        "領隊、證保",
	...
	},
	{
		...
		Role:        "Mentor",
		Jobs:        "輔隊",
		UserProfile: ProfileList[1],
	},
	{
		UserId:      3,
		Role:        "Member",
		Jobs:        "大廚、裝備、學員",
		UserProfile: ProfileList[2],
	},
	{
		UserId:      4,
		Role:        "Member",
		Jobs:        "",
		UserProfile: ProfileList[3],
	},
}

var EventInfoData = schoolForm.EventInfo{
	Id:             1,
	...
	Attendants: FullAttendanceList,
	Rescues:    []schoolForm.Attendance{AttendenceList[0]},
